exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
 ...
 var inspiring = [
  ...
  { front:'', back:', did you know NicNacs favorite holiday is Christmas? ' },
   ...
   { front:'Looks like ', back:' is going to eclipse me in 2 years!'},

  { front:'Good job! Remember to stretch your wrists once in a while, ', back:'!'},

  { front:'', back:', did you know Aggretsukos favorite food is fries and ketchup? '},

  { front:'Good job ', back:', believe in the me that believes in you! <3 ' },
  { front:'Nicely done ', back:', 100% GMI material.'},
...
exports.help = {
  name: "points",
  category: "LAS-Houses",
  description: "Use this command to add house points for your piece.",
  usage: "points"
};

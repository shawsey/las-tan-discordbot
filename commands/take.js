...
exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  // Limited to guild owner - adjust to your own preference!
    ...
    if(!pointsToAdd) return message.reply("You didn't tell me how many points to take...");
    ...
    message.reply(`${user.tag} has taken ** ${pointsToAdd} points. **`);
...
exports.help = {
  ...
  description: "Only for taking points. No touchy touchy if you shouldnt be.",
  usage: "take"
};
